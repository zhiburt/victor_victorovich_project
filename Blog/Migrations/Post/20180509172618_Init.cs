        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_CommentsLayer_CommentsId",
                        column: x => x.CommentsId,
                        principalTable: "CommentsLayer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Posts_LikeLayer_LikesId",
                        column: x => x.LikesId,
                        principalTable: "LikeLayer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Posts_RepostsLayer_RepostsId",
                        column: x => x.RepostsId,
                        principalTable: "RepostsLayer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Posts_TagsLayer_TagsId",
                        column: x => x.TagsId,
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Repost_Posts_NaturePostId",
                table: "Repost",
                column: "NaturePostId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Posts_UserIndentity_CreatorId",
                table: "Posts",
                column: "CreatorId",
                principalTable: "UserIndentity",
                principalColumn: "Id",
