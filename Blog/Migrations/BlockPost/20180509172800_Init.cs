        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlockPostId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Repost_Comment_CommentId",
                        column: x => x.CommentId,
                        principalTable: "Comment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Repost_LikeLayer_LikesId",
                        column: x => x.LikesId,
                        principalTable: "LikeLayer",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BlockPosts_UserIndentity_CreatorId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Comment_BlockPosts_BlockPostId",
                table: "Comment",
                column: "BlockPostId",
                principalTable: "BlockPosts",
                principalColumn: "Id",
                onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Like_BlockPosts_BlockPostId",
                table: "Like",
                column: "BlockPostId",
                principalTable: "BlockPosts",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Post_BlockPosts_BlockPostId",
                table: "Post",
                column: "BlockPostId",
                principalTable: "BlockPosts",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Repost_BlockPosts_BlockPostId",
                table: "Repost",
                column: "BlockPostId",
                principalTable: "BlockPosts",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Tag_BlockPosts_BlockPostId",
                table: "Tag",
                column: "BlockPostId",
                principalTable: "BlockPosts",
                principalColumn: "Id",
